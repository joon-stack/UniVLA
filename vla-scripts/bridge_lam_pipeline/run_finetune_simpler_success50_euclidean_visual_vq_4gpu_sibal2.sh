...
SIMPLER_DATA_ROOT="${SIMPLER_DATA_ROOT:-/tmp/youngjoon_univla_data/simpler_mvplam_noeval_success50_rlds}"
...
env \
  ...
  HF_UPLOAD_REPO_ID="${HF_UPLOAD_REPO_ID:-joon-stack/univla-simpler-success50-euclidean-visual-vq-vla50k-step5000}" \
  ...
  HF_UPLOAD_NOTES="${HF_UPLOAD_NOTES:-UniVLA Simpler success50 euclidean visual VQ finetune.}" \
