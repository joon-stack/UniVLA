...
COMMON_ENV=(
  ...
  LAM_CONFIG_PATH="${REPO}/latent_action_model/config/lam-visual-vq-bridge-euclidean-plain-4tokens-k32-30k-8gpu.yaml"
  LAM_CKPT="${ROOT}/outputs/lam_bridge/logs/visual_vq_lam_bridge_euclidean_plain_4tokens_k32_30k_8gpu_b64_global512_workers2/epoch=0-step=30000.ckpt"
  LAM_CODEBOOK_SIZE=32
  LAM_LATENT_ACTION_TOKEN_LEN=4
  VLA_MAX_STEPS=50000
  VLA_SHUFFLE_BUFFER_SIZE=20000
  VLA_RUN_ROOT="${ROOT}/outputs/univla_bridge_euclidean_plain_4tokens_k32_lam30k_8gpu_g256"
  VLA_RUN_NOTE=bridge_dataset_euclidean_plain_4tokens_k32_lam30k_50k_8gpu_g256
  VLA_WANDB_PROJECT=univla_bridge_lam_local
  VLA_CKPT_STEP=050000
  HF_VLA_DIR="${ROOT}/outputs/hf_univla_bridge_euclidean_plain_4tokens_k32_lam30k_8gpu_g256_step050000"
  LOG_ROOT="${ROOT}/outputs/bridge_pipeline_logs/euclidean_plain_4tokens_k32_vla_lam30k_50k_sibal2_8gpu_g256"
)
