...
SIMPLER_DATA_ROOT=/NHNHOME/WORKSPACE/0526040036_A/BASE/user/01/youngjoonjeong/data/simpler_mvplam_noeval_success10_rlds
...
env \
  ...
  FINETUNE_RUN_ROOT=/NHNHOME/WORKSPACE/0526040036_A/BASE/user/01/youngjoonjeong/outputs/finetune_simpler_success10_factorized_vla50k_sibal2_workers2_4gpu \
  FINETUNE_ADAPTER_TMP_DIR=/NHNHOME/WORKSPACE/0526040036_A/BASE/user/01/youngjoonjeong/outputs/finetune_simpler_success10_factorized_vla50k_sibal2_workers2_4gpu_adapter_tmp \
  LOG_ROOT=/NHNHOME/WORKSPACE/0526040036_A/BASE/user/01/youngjoonjeong/outputs/bridge_pipeline_logs/factorized_simpler_success10_sibal2_workers2_4gpu \
  WANDB_MODE=online \
  ...
  HF_UPLOAD_REPO_ID="${HF_UPLOAD_REPO_ID:-joon-stack/univla-simpler-success10-factorized-vla50k-step5000}" \
  ...
  HF_UPLOAD_NOTES="${HF_UPLOAD_NOTES:-UniVLA Simpler success10 factorized finetune.}" \
