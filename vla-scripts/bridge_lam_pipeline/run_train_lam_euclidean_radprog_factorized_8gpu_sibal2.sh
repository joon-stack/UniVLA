...
RUN_NAME=visual_vq_lam_bridge_euclidean_radprog_factorized_rad16_0to6_dir16_rad1_dir4tokens_50k_workers2
...
env \
  ...
  PYTHON="${PYTHON_BIN}" \
  LAM_CONFIG=config/lam-visual-vq-bridge-euclidean-radprog-factorized-50k.yaml \
  ...
  LOG_ROOT="${ROOT}/outputs/bridge_pipeline_logs/euclidean_radprog_factorized_lam_50k_sibal2_4gpu" \
