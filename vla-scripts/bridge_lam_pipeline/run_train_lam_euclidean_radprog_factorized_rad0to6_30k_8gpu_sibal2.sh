...
RUN_NAME=visual_vq_lam_bridge_euclidean_radprog_factorized_rad16_0to6_dir16_rad1_dir4tokens_30k_8gpu_b64_global512_workers2
...
env \
  ...
  PYTHON="${PYTHON_BIN}" \
  LAM_CONFIG=config/lam-visual-vq-bridge-euclidean-radprog-factorized-rad0to6-30k-8gpu.yaml \
  ...
  LOG_ROOT="${ROOT}/outputs/bridge_pipeline_logs/euclidean_radprog_factorized_rad0to6_lam_30k_sibal2_8gpu_b64_global512" \
