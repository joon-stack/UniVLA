...
RUN_NAME=visual_vq_lam_bridge_euclidean_plain_4tokens_k32_30k_8gpu_b64_global512_workers2
...
env \
  ...
  PYTHON="${PYTHON_BIN}" \
  LAM_CONFIG=config/lam-visual-vq-bridge-euclidean-plain-4tokens-k32-30k-8gpu.yaml \
  ...
  LOG_ROOT="${ROOT}/outputs/bridge_pipeline_logs/euclidean_plain_4tokens_k32_lam_30k_sibal2_8gpu_b64_global512" \
